<template>
	<view class="container">
		...
		<view class="user">
			<view class="user-top">
				<view class="user-top-left" @click="goLogin()">
...
<style>
	page {
<<<<<<< HEAD
		background: linear-gradient(180deg, #f3ebff 0%, #ffffff 72%);
=======
		background: #F8F9FA;
...
<<<<<<< HEAD
		background: linear-gradient(180deg, #f2e8ff 0%, #e9ddff 100%);
=======
		background: #FED12F;
>>>>>>> b82c8976e75deb4638d7c2d0dbfdc908a3704f8d
		opacity: 1;
