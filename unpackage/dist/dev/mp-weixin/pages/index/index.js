...
/***/ 39:
/*!*************************************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*************************************************************************************************/
...
/***/ 40:
/*!******************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ 41:
/*!*************************************************************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue?vue&type=template&id=57280228&scoped=true& ***!
  \*************************************************************************************************************************/
...
var render = function () {
  ...
  var l0 =
    g0 > 0
      ? _vm.__map(_vm.reviewList, function (item, __i1__) {
...
/***/ 43:
/*!*******************************************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  data: function data() {
    return {
      ...
      hotServices: [{
        id: 1,
        name: '空调清洗',
        image: '/static/pack1.png',
        price: 138,
        originPrice: 158
      }, {
        id: 2,
        name: '宠物保洁',
        image: '/static/pack2.png',
        price: 90,
        originPrice: 99
      }, {
        id: 3,
        name: '日常保洁',
        image: '/static/pack3.png',
        price: 50,
        originPrice: 80
      }, {
        id: 4,
        name: '深度保洁',
        image: '/static/pack4.png',
        price: 70,
        originPrice: 99
      }, {
        id: 5,
        name: '新居开荒',
        image: '/static/pack5.png',
        price: 85,
        originPrice: 120
      }, {
        id: 6,
        name: '公司保洁',
        image: '/static/pack6.png',
        price: 70,
        originPrice: 80
      }],
      reviewList: [],
  ...
  computed: {
    reviewDisplayCount: function reviewDisplayCount() {
      var count = this.reviewList.length;
      if (count <= 0) return '0';
  ...
  methods: {
    ...
    normalizeTags: function normalizeTags(tags) {
      if (!tags) return [];
      var list = String(tags).split(/[,，|\s]+/).map(function (item) {
        return item.trim();
      }).filter(Boolean);
      return list.slice(0, 3);
    },
    normalizeImages: function normalizeImages(item) {
      var raw = (item === null || item === void 0 ? void 0 : item.images) || (item === null || item === void 0 ? void 0 : item.imageUrls) || (item === null || item === void 0 ? void 0 : item.pics) || (item === null || item === void 0 ? void 0 : item.pictures) || '';
      if (!raw) return [];
    ...
    getHomeReviewList: function getHomeReviewList() {
      var _this2 = this;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                body = _context.sent;
                list = Array.isArray(body === null || body === void 0 ? void 0 : body.data) ? body.data : [];
                _this2.reviewList = list.slice(0, 8).map(function (item, idx) {
                  return {
                    id: item.id || idx,
                    visitorName: _this2.normalizeName(item.visitorName),
                    content: item.content || '用户未填写评价内容',
                    tagList: _this2.normalizeTags(item.tags),
                    imageList: _this2.normalizeImages(item)
                  };
                });
                _context.next = 12;
                break;
              case 9:
                ...
                console.error('获取首页评价失败:', _context.t0);
              case 12:
              case "end":
    ...
    getCurrentAddress: function getCurrentAddress() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var timeoutId, location, parsed;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                timeoutId = setTimeout(function () {
                  if (_this3.address === '定位中...') {
                    _this3.address = '已定位';
                  }
                }, 4000);
                _context2.prev = 1;
                _context2.next = 4;
                return _this3.getLocationWithPermission();
              case 4:
                location = _context2.sent;
                _this3.latitude = location.latitude;
                _this3.longitude = location.longitude;
                parsed = _this3.extractCityDistrict(location);
                console.log(parsed, 'parsed');
                _this3.address = parsed || '已定位';
                _context2.next = 15;
                break;
              case 12:
                _context2.prev = 12;
                _context2.t0 = _context2["catch"](1);
                _this3.address = '南充市-顺庆区';
              case 15:
                _context2.prev = 15;
    ...
    getLocationWithPermission: function getLocationWithPermission() {
      var _this4 = this;
      return new Promise(function (resolve, reject) {
        var tryGetLocation = function tryGetLocation() {
          _this4.getLocationInfo().then(resolve).catch(function (err) {
            if (String((err === null || err === void 0 ? void 0 : err.errMsg) || '').indexOf('auth') !== -1 || String((err === null || err === void 0 ? void 0 : err.errMsg) || '').indexOf('deny') !== -1) {
              uni.authorize({
                scope: 'scope.userLocation',
                success: function success() {
                  return _this4.getLocationInfo().then(resolve).catch(reject);
                },
                fail: function fail() {
                  uni.openSetting({
                    success: function success(openRes) {
                      var _openRes$authSetting;
                      if (openRes !== null && openRes !== void 0 && (_openRes$authSetting = openRes.authSetting) !== null && _openRes$authSetting !== void 0 && _openRes$authSetting['scope.userLocation']) {
                        _this4.getLocationInfo().then(resolve).catch(reject);
                      } else {
        ...
        uni.getSetting({
          success: function success(settingRes) {
            var auth = (settingRes === null || settingRes === void 0 ? void 0 : settingRes.authSetting) || {};
            if (auth['scope.userLocation'] === false) {
              uni.openSetting({
                success: function success(openRes) {
                  var _openRes$authSetting2;
                  if (openRes !== null && openRes !== void 0 && (_openRes$authSetting2 = openRes.authSetting) !== null && _openRes$authSetting2 !== void 0 && _openRes$authSetting2['scope.userLocation']) {
                    tryGetLocation();
                  } else {
                    reject(new Error('user denied location permission'));
                  }
    ...
    parseCityDistrict: function parseCityDistrict(fullAddress) {
      if (!fullAddress) return '';
      var cleaned = String(fullAddress).replace(/\s/g, '');
      var match = cleaned.match(/(.*?市)(.*?(区|县|市))/);
      if (match && match[1] && match[2]) {
        return "".concat(match[1], "-").concat(match[2]);
      }
      return '';
    },
    extractCityDistrict: function extractCityDistrict(location) {
      var _location$address, _location$address_com, _location$ad_info, _location$address2, _location$address_com2, _location$ad_info2, _location$address3;
      if (!location) return '';
      var city = location.city || (location === null || location === void 0 ? void 0 : (_location$address = location.address) === null || _location$address === void 0 ? void 0 : _location$address.city) || (location === null || location === void 0 ? void 0 : (_location$address_com = location.address_component) === null || _location$address_com === void 0 ? void 0 : _location$address_com.city) || (location === null || location === void 0 ? void 0 : (_location$ad_info = location.ad_info) === null || _location$ad_info === void 0 ? void 0 : _location$ad_info.city) || '';
      var district = location.district || (location === null || location === void 0 ? void 0 : (_location$address2 = location.address) === null || _location$address2 === void 0 ? void 0 : _location$address2.district) || (location === null || location === void 0 ? void 0 : (_location$address_com2 = location.address_component) === null || _location$address_com2 === void 0 ? void 0 : _location$address_com2.district) || (location === null || location === void 0 ? void 0 : (_location$ad_info2 = location.ad_info) === null || _location$ad_info2 === void 0 ? void 0 : _location$ad_info2.district) || '';
      if (city && district) return "".concat(city, "-").concat(district);
      var full = location.address || (location === null || location === void 0 ? void 0 : location.formattedAddress) || (location === null || location === void 0 ? void 0 : (_location$address3 = location.address) === null || _location$address3 === void 0 ? void 0 : _location$address3.formattedAddress) || '';
    ...
    guid: function guid() {
      return "id_".concat(Date.now(), "_").concat(Math.random().toString(36).slice(2, 10));
    },
    ...
    toDetail: function toDetail(item) {
      var payload = this.buildDetailCache(item);
      uni.setStorageSync('package_detail_cache', payload);
      var goods = encodeURIComponent(JSON.stringify(payload));
      uni.navigateTo({
        url: "/pkgGoods/detail?goods=".concat(goods)
      });
    },
...
/***/ 49:
/*!***************************************************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 51:
/*!****************************************************************************************************************************************!*\
  !*** C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue?vue&type=style&index=1&id=57280228&lang=scss&scoped=true& ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 52:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Sun/Documents/HBuilderProjects/生鲜商城前端模板/pages/index/index.vue?vue&type=style&index=1&id=57280228&lang=scss&scoped=true& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
