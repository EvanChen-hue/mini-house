...
var _default = {
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                timeoutId = setTimeout(function () {
                  if (_this2.address === '定位中...') {
                    _this2.address = '已定位';
                  }
                }, 4000);
                _context.prev = 1;
                _context.next = 4;
                return _this2.getLocationWithPermission();
              case 4:
                location = _context.sent;
                _this2.latitude = location.latitude;
                _this2.longitude = location.longitude;
                parsed = _this2.extractCityDistrict(location);
                console.log(parsed, 'parsed');
                _this2.address = parsed || '已定位';
                _context.next = 15;
                break;
              case 12:
                _context.prev = 12;
                _context.t0 = _context["catch"](1);
                _this2.address = '南充市-顺庆区';
              case 15:
                _context.prev = 15;
    ...
    getLocationWithPermission: function getLocationWithPermission() {
      ...
      return new Promise(function (resolve, reject) {
        var tryGetLocation = function tryGetLocation() {
          _this3.getLocationInfo().then(resolve).catch(function (err) {
            if (String((err === null || err === void 0 ? void 0 : err.errMsg) || '').indexOf('auth') !== -1 || String((err === null || err === void 0 ? void 0 : err.errMsg) || '').indexOf('deny') !== -1) {
              uni.authorize({
                ...
                success: function success() {
                  return _this3.getLocationInfo().then(resolve).catch(reject);
                },
                fail: function fail() {
                  uni.openSetting({
                    success: function success(openRes) {
                      ...
                      if (openRes !== null && openRes !== void 0 && (_openRes$authSetting = openRes.authSetting) !== null && _openRes$authSetting !== void 0 && _openRes$authSetting['scope.userLocation']) {
                        _this3.getLocationInfo().then(resolve).catch(reject);
                      } else {
    ...
    toDetail: function toDetail(item) {
      var goods = encodeURIComponent(JSON.stringify(item || {}));
      uni.navigateTo({
